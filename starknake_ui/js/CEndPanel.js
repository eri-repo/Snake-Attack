function CEndPanel(oSpriteBg) {
    ...
    this.show = function (iScore, iPointsEarned) {
        playSound("game_over", 1, false);

        _oMsgTextBack.text = TEXT_GAMEOVER;
        _oMsgText.text = TEXT_GAMEOVER;

        _oScoreTextBack.text = TEXT_SCORE + ": " + iPointsEarned;
        _oScoreText.text = TEXT_SCORE + ": " + iPointsEarned;
        ...
        $(s_oMain).trigger("save_score", iPointsEarned);
